...
export default function Home() {
  ...
  <div className='ml-6 flex flex-col justify-center'>
    ...
    <a className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded w-min block my-2 " download="utkarsh_sinha" href='/UtkarshSinha2025 (2).pdf'>Resume</a>
  </div>
</section>
